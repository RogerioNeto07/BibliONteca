# Generated by Django 5.1.3 on 2025-02-23 15:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='library.categoria')),
            ],
        ),
        migrations.CreateModel(
            name='Emprestimo',
            fields=[
                ...
                ('previsao_devolucao', models.DateField(blank=True)),
                ...
                ('livro', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='emprestimos', to='library.livro')),
            ],
        ),
        migrations.CreateModel(
            name='Comentarios',
